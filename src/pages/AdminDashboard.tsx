...
const AdminDashboard = () => {
  ...
  const filteredApplications = applications.filter(app => {
    ...
    const matchesBank = bankFilter === "all" || app.bank_name.toLowerCase().includes(bankFilter.toLowerCase());
                ...
                <Card className="bg-gradient-to-br from-white/95 to-indigo-50/30 backdrop-blur-sm shadow-elegant border border-white/20 hover:shadow-2xl hover:shadow-indigo-100 transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2 group">
                      ...
                      <span className="bg-gradient-to-r from-slate-800 to-indigo-600 bg-clip-text text-transparent transition-all duration-300 group-hover:from-indigo-600 group-hover:to-purple-600">Loan Applications</span>
                    </CardTitle>
                    <CardDescription className="text-slate-600 transition-colors duration-200 group-hover:text-indigo-600">Manage all loan applications</CardDescription>
